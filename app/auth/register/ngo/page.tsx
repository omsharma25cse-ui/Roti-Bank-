  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { data, error: authError } = await supabase.auth.signUp({
        ...
        password,
        options: {
          emailRedirectTo: process.env.NEXT_PUBLIC_DEV_SUPABASE_REDIRECT_URL || `${window.location.origin}/ngo`,
          data: {
            user_type: "ngo",
      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col gap-6">
          <div className="text-center">
            ...
            />
            <h1 className="text-2xl font-bold text-foreground">Join as NGO</h1>
            <p className="text-muted-foreground">Partner with us to receive food donations</p>
          </div>
          ...
          <Card className="animate-fade-in-up">
            <CardHeader>
              ...
              <CardDescription>Create your NGO account to start receiving donations</CardDescription>
            </CardHeader>
            <CardContent>
