      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col gap-6">
          <div className="text-center">
            ...
            />
            <h1 className="text-2xl font-bold text-foreground">Join as Volunteer</h1>
            <p className="text-muted-foreground">Help collect and distribute food to make a difference</p>
          </div>
          ...
          <Card className="animate-fade-in-up">
            <CardHeader>
              ...
              <CardDescription>Create your volunteer account to start helping</CardDescription>
            </CardHeader>
            <CardContent>
